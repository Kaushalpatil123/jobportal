...
const InternationalVisualEntry = () => {
  ...
  const [executiveLevel, setexecutiveLevel] = useState();
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await axios.get(
          `${process.env.REACT_APP_SERVER_PRO_URL}/api/visualinternationalresume/plans`
        );
        const { status, plans } = response.data;
        if (status === "success" && Array.isArray(plans) && plans.length > 0) {
          setexecutiveLevel(plans[3]);
        }
      } catch (error) {
  ...
  const cardContents = [
    {
      ...
      content:
        "Our team reviews your information to understand your career goals, strengths, and unique selling points",
      icon: icon1,
    },
    {
      steps: "Step 2",
      ...
      content:
        "The text resume is formatted for maximum readability on various devices, ensuring it maintains a professional appearance.",
      icon: icon2,
    },
    {
      steps: "Step 3",
      ...
      content:
        "We deliver the text-optimized resume. Use it for online applications where text submission is accepted",
      icon: icon3,
    },
    {
      steps: "Step 4",
      ...
      content:
        "Our text resume is designed to make an instant impression, helping you stand out in the competitive job market",
      icon: icon4,
    },
  ];
  ...
  return (
    <div className="w-[100%] mx-auto">
        ...
        >
          <div className="flex flex-col justify-between h-full px-7 w-[100%]">
            <div className="pb-4">
              ...
              >
                Visual International Resumes: <br className="block" /> Elevate
                Your Profile, Expand your Horizons
              </div>
              <div
            ...
            >
              <Grid item xs={6} sm={3}>
                <Item
                  ...
                  onClick={() =>
                    navigate("/Visual-Resume-International-Entry-Level")
                  }
                >
              ...
              <Grid item xs={6} sm={3}>
                <Item
                  className="cursor-pointer rounded-md sm:rounded-t-md sm:rounded-b-none"
                  onClick={() =>
                    navigate("/Visual-Resume-International-Middle-Level")
                  }
                >
                  <b className="text-base md:text-lg lg:text-base xl:text-lg">
                    Middle-Level{" "}
              ...
              <Grid item xs={6} sm={3}>
                <Item
                  className="cursor-pointer rounded-md sm:rounded-t-md sm:rounded-b-none"
                  onClick={() =>
                    navigate("/Visual-Resume-International-Senior-Level")
                  }
                >
                  <b className="text-base md:text-lg lg:text-base xl:text-lg">
                    Senior-Level
              ...
              <Grid item xs={6} sm={3}>
                <Item
                  ...
                  onClick={() =>
                    navigate("/Visual-Resume-International-Executive-Level")
                  }
                >
                  <b className="text-base md:text-lg lg:text-base xl:text-lg">
                    Executive-Level{" "}
      ...
      <div
        className="flex justify-center bg-orange-400 w-[100%] mt-2"
        style={{
          fontSize: 18,
          fontWeight: "500",
      ...
      >
        <div className="text-white text-center self-center w-[100%] xl:w-[70%] max-md:max-w-full max-w-[1500px] mx-auto text-sm sm:text-xl md:text-2xl lg:text-2xl font-medium flex justify-center items-center">
          Doledge's Visual International Resume Services: Unleash{" "}
          <br className="block" /> Your International Career Potential with Our
      ...
      {executiveLevel && (
        <DoledgeBenefits
          plans={executiveLevel}
          name={"International Visual Resume"}
        />
      )}
        ...
        <div className="w-[90%] lg:w-[70%] max-w-[1500px] mx-auto flex flex-col gap-y-5 font-medium">
          ...
          <div className="text-left pl-4">
            ...
            <span
              ...
              style={{ fontFamily: "Poppins" }}
            >
              Strategically incorporate industry-specific keywords to make your
              resume stand out
            </span>
          </div>
          ...
          <div className="text-left pl-4">
            ...
            <span
              ...
              style={{ fontFamily: "Poppins" }}
            >
              Our designers create professional, aesthetically pleasing text
              resumes
            </span>
          </div>
          {/* 4 */}
          <div className="text-left pl-4">
            ...
            <span
              ...
              style={{ fontFamily: "Poppins" }}
            >
              We valuing your input and preferences to produce a resume that
      ...
      <div className="mx-auto mt-8 sm:mt-16 md:w-[70%] max-w-[1500px]">
        <h1 className="text-[22px] sm:text-3xl leading-[42px] font-semibold">
          Resume Delivery Time
        </h1>
        <div className="my-8">
