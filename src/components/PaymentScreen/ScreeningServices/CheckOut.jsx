...
export default function CheckOut() {
  ...
  const { cartItem, totalAmount, gst, payableAmount, cartId } = state;
  ...
  const handleClick = async () => {
    ...
    try {
      const response = await axios.post(
        `${process.env.REACT_APP_SERVER_PRO_URL}/api/payment/handleccavenueresponse`,
        data,
    ...
    <div style={{ fontFamily: "sans-serif" }}>
      ...
      <div className="flex flex-col justify-between mx-auto mt-8 w-[100%] lg:w-[85%] xl:w-[85%] max-w-[1500px]">
        ...
        <div className="flex lg:flex-row flex-col mb-10 ">
          ...
          <div
            className="flex flex-col max-sm:flex-col ml-20 sm:w-1/2 "
          ...
          >
              ...
              <div className="flex flex-col gap-3">
                ...
                {cartItem?.map((item) => (
                  <div className="flex justify-between" key={item?._id}>
                    ...
                    <span>
                      {" "}
                      <span className=" text-[17px]  text-slate-500 font-medium">
                        ₹
                ...
                <div className="flex justify-between">
                  <span className="font-bold text-[14px]">18% GST</span>
                  <span className=" text-[17px]  text-slate-500">
                    ₹{gst.toFixed(2)}/-
                  </span>
                </div>
            ...
            <div
              className="max-sm:w-[90%]  ml-4 mt-7 mx-auto text-left"
